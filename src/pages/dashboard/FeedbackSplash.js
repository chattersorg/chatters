            ...
            {venue.enabledLinks
              ...
              .map((link) => (
                <button
                  ...
                  className="w-full py-4 px-6 rounded-xl font-medium text-lg transition-all duration-200 hover:scale-105 border-2 hover:shadow-md flex items-center justify-center gap-3 bg-white"
                  style={{
